...
# cnn_tdnn_lstm_1o = fast-lstm + dropout + proportional shrink (without decay-time)
...
tlstm_affix=1x  #affix for TDNN-LSTM directory, e.g. "a" or "b", in case we change the configuration.
