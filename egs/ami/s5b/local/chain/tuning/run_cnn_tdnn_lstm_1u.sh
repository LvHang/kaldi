...
# cnn_tdnn_lstm_1m = fast-lstm + dropout + proportional shrink + decaytime
...
tlstm_affix=1u  #affix for TDNN-LSTM directory, e.g. "a" or "b", in case we change the configuration.
