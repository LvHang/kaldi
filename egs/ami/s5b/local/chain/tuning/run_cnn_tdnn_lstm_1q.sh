...
# cnn_tdnn_lstm_1o = fast-lstm + (without dropout) + proportional shrink (without decay-time)
...
tlstm_affix=1q  #affix for TDNN-LSTM directory, e.g. "a" or "b", in case we change the configuration.
