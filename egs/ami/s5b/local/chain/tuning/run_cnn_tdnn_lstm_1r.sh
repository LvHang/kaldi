...
# cnn_tdnn_lstm_1r.sh = fast-lstm + (without dropout) + (without proportional-shrink) + decay_time
...
tlstm_affix=1r  #affix for TDNN-LSTM directory, e.g. "a" or "b", in case we change the configuration.
