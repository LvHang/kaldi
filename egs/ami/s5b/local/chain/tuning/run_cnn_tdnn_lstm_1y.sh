...
# cnn_tdnn_lstm_1m = fast-lstm + (without dropout) + proportional shrink + decaytime
...
tlstm_affix=1y  #affix for TDNN-LSTM directory, e.g. "a" or "b", in case we change the configuration.
