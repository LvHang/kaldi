...
# cnn_tdnn_lstm_1n = fast-lstm + dropout (without proportional shrink) (without decay-time)
...
tlstm_affix=1t  #affix for TDNN-LSTM directory, e.g. "a" or "b", in case we change the configuration.
