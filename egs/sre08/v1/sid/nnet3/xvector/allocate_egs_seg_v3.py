...
def main():
    ...
    if (args.generate_validate == "false") :
        for i in range(0, args.kinds_of_length):
            ...
            this_feats_filename = this_dir_name + "/feats.scp"
                ...
                if (args.average_method == "false") :
                    ...
                    for k in range(len(args.num_egs_per_speaker_per_length)):
                        ...
                        if this_utt_len < this_length:
                            ...
                            new_utt_id = "{0}-{1}-{2}".format(this_utt_id,
                                    start_point, this_length)
                            new_extend = "{0}[{1}:{2}]".format(this_extend,
                                    start_point, start_point+this_length-1)
